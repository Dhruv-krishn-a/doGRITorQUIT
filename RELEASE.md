# 🚀 Dogrit Planner: The Professional Production Release Blueprint
...
2.  **Repository Name:** `dogrit-planner-releases`.
3.  **Visibility:** **Public**.
...
2.  You will see a job named "Release Dogrit Planner" running.
...
1.  The user opens Dogrit Planner v1.0.0.
2.  The app silently checks `https://dogritorquit.in/api/update/...`.
