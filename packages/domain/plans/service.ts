 ...
 * Task CRUD
 */
export async function createTask(userId: string, planId: string | null | undefined, data: {
  title: string;
  description?: string; 
  date: string; 
  dueDate?: string | null;
  ...
  return prisma.$transaction(async (tx) => {
    ...
    const updated = await tx.task.update({
        ...
        data: {
            ...
            status: safeStatus,
            completed: safeStatus === TaskStatus.completed ? true : safeStatus === TaskStatus.pending ? false : undefined,
