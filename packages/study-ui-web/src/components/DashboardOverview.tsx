  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 min-w-0">
        ...
        <motion.div 
          variants={item}
          className="lg:col-span-8 min-w-0 bg-white rounded-[3rem] p-6 md:p-10 shadow-2xl shadow-pink-100/40 relative overflow-hidden group border border-pink-50"
        >
          <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-gradient-to-br from-pink-50 to-rose-50 rounded-full blur-[80px] -translate-y-1/2 translate-x-1/3 pointer-events-none transition-transform duration-1000 group-hover:scale-110 opacity-60" />
            ...
            <div className="flex items-center gap-6 md:gap-8 min-w-0">
              <div className="relative shrink-0">
                <motion.div 
                  initial={{ rotate: -10 }}
                  animate={{ rotate: 0 }}
                  className="w-24 h-24 md:w-28 md:h-28 border-[6px] border-white bg-gradient-to-br from-pink-50 to-white rounded-full flex items-center justify-center shadow-[0_10px_30px_rgba(236,72,153,0.15)] relative z-10"
                >
                   <span className="text-4xl md:text-5xl font-black italic tracking-tighter text-transparent bg-clip-text bg-gradient-to-br from-pink-600 to-rose-500">{data.stats?.currentLevel}</span>
                </motion.div>
              ...
              <div className="min-w-0">
                ...
                <p className="text-2xl md:text-4xl font-black tracking-tight uppercase text-slate-900 truncate">Advanced Learner</p>
              </div>
            </div>
          ...
          <div className="relative z-10 space-y-4">
            ...
            <div className="h-6 w-full bg-slate-50 rounded-full overflow-hidden border border-slate-100 p-1 shadow-inner">
              <motion.div 
                ...
                className="h-full bg-gradient-to-r from-pink-500 via-rose-500 to-fuchsia-500 rounded-full shadow-[0_2px_10px_rgba(236,72,153,0.3)] relative overflow-hidden"
              >
        ...
        <motion.div 
          variants={item}
          className="lg:col-span-4 min-w-0 bg-white rounded-[3rem] border border-pink-50 p-10 shadow-xl shadow-pink-100/30 flex flex-col items-center justify-center text-center relative overflow-hidden group hover:border-pink-100 transition-colors"
        >
           ...
           <p className="text-[11px] text-slate-400 font-bold max-w-[200px] leading-relaxed break-words">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 w-full min-w-0">
        ...
        <motion.div 
          variants={item}
          whileHover={{ y: -5 }}
          className="lg:col-span-7 min-w-0 bg-gradient-to-br from-pink-600 to-rose-700 rounded-[3.5rem] p-8 md:p-12 text-white relative overflow-hidden group shadow-2xl shadow-pink-200/50 flex flex-col justify-between"
        >
          ...
          <div className="relative z-10 flex flex-col h-full min-w-0">
            <div className="min-w-0 flex-1">
              <div className="flex items-center gap-4 mb-8">
                ...
                <span className="text-[10px] font-black text-pink-100 uppercase tracking-widest truncate min-w-0 w-full block">
                  {data.globalNextUnit?.track?.title || "No Track"}
                </span>
              </div>

              <h2 className="text-3xl md:text-5xl font-black tracking-tight mb-6 leading-[1.05] max-w-lg drop-shadow-sm break-words whitespace-normal">
                {data.globalNextUnit?.title || "Neural engine idle. Initialize a learning vector."}
              </h2>
              
              <p className="text-pink-100 font-bold text-sm md:text-base max-w-md line-clamp-3 overflow-hidden leading-relaxed tracking-wide opacity-90 break-words whitespace-normal">
                ...
                renderLink({
                  ...
                  children: (
                    <>
                      ...
                      <span className="truncate">Resume Protocol</span>
                    </>
                  )
                })
              ) : (
        ...
        <motion.div variants={item} className="lg:col-span-5 min-w-0 flex flex-col gap-8">
           <div className="bg-white rounded-[3.5rem] border border-slate-100 p-8 md:p-10 shadow-xl shadow-slate-200/20 flex-1 flex flex-col relative overflow-hidden min-h-[300px] max-h-[450px]">
              <div className="flex items-center justify-between mb-8 px-2 relative z-10 shrink-0">
                <h3 className="text-[10px] md:text-xs font-black text-slate-400 uppercase tracking-[0.4em] flex items-center gap-3">
                  ...
                  <span className="truncate">Neural Decay</span>
                </h3>
                  ...
                  data.dueRevisions.map((unit) => (
                    <React.Fragment key={unit.id}>
                      {renderLink({
                        ...
                        className: "group block p-4 md:p-5 rounded-[2rem] bg-slate-50/50 border border-slate-100 hover:border-pink-200 hover:bg-white hover:shadow-lg hover:shadow-pink-100/20 transition-all duration-300 min-w-0",
                        children: (
                          <>
                            ...
                            <p className="text-sm font-bold text-slate-700 line-clamp-1 group-hover:text-pink-600 transition-colors uppercase tracking-tight break-words">
                              {unit.title}
                            </p>
                          </>
                        )
           ...
           <div className="grid grid-cols-2 gap-4 md:gap-6 w-full min-w-0">
              <motion.div className="bg-white p-6 md:p-8 rounded-[2.5rem] border border-slate-100 shadow-lg shadow-slate-200/20 flex flex-col items-center justify-center text-center gap-3 group min-w-0">
                 ...
                 <div className="min-w-0">
                    <p className="text-2xl md:text-3xl font-black text-slate-900 tracking-tighter leading-none truncate">{data.streak}</p>
                    <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest mt-1 truncate">Day Streak</p>
                 </div>
              </motion.div>
              <motion.div className="bg-white p-6 md:p-8 rounded-[2.5rem] border border-slate-100 shadow-lg shadow-slate-200/20 flex flex-col items-center justify-center text-center gap-3 group min-w-0">
                 ...
                 <div className="min-w-0">
                    <p className="text-2xl md:text-3xl font-black text-slate-900 tracking-tighter leading-none truncate">{Math.floor(data.weeklyTimeMinutes / 60)}h</p>
                    <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest mt-1 truncate">Focus Time</p>
                 </div>
              </motion.div>
           </div>
        </motion.div>
