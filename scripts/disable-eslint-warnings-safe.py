...
for file_info in data:
    ...
    for msg in messages:
        ...
        # We only disable these specific rules
        if rule not in ["@typescript-eslint/no-explicit-any", "react-hooks/exhaustive-deps", "@typescript-eslint/no-unused-vars", "unused-imports/no-unused-vars"]:
            continue
...
print("Done disabling remaining minor rules safely")
