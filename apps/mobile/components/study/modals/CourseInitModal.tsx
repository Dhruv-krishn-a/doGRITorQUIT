            ...
            <View className="space-y-12">
              ...
              <View className="text-left">
                 ...
                 <TextInput autoCorrect={false} spellCheck={false}
                   ...
                   placeholder="E.G., 5"
                   placeholderTextColor={colors.textSecondary + '40'}
                   className="bg-[var(--bg-primary)] border border-[var(--border-color)] p-8 rounded-[2rem] font-black text-xl text-[var(--text-primary)] uppercase italic tracking-tight text-left"
                 />
              </View>
              ...
              <TouchableOpacity 
                ...
                className={`py-8 rounded-[2.5rem] items-center justify-center ${!title ? 'opacity-30 bg-[var(--bg-secondary)]' : 'bg-fuchsia-600'}`}
              >
