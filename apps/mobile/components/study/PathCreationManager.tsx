  ...
  const OptionButton = ({ icon, label, sublabel, onPress, accent = false }: any) => (
    <TouchableOpacity 
      ...
      className={`p-6 rounded-[2.5rem] border mb-4 flex-row items-center ${
        accent ? 'bg-[var(--accent-color)] border-[var(--accent-color)] shadow-lg' : 'bg-[var(--bg-secondary)]/50 border-[var(--border-color)]'
      }`}
    >
      ...
      >
        <View className="flex-1 justify-end bg-black/60">
          <View 
            ...
            className="rounded-t-[3.5rem] p-8 pb-16 border-t border-[var(--border-color)] shadow-2xl max-h-[90%]"
          >
            {/* Header */}
              ...
              {mode === 'MANUAL' && (
                <View className="space-y-8">
                  ...
                  <View className="flex-row gap-4">
                    <TouchableOpacity onPress={() => handleManualCreate('COURSE')} className="flex-1 bg-[var(--bg-secondary)] p-6 rounded-[2rem] border border-[var(--border-color)] items-center shadow-sm">
                    ...
                    <TouchableOpacity onPress={() => handleManualCreate('PROJECT')} className="flex-1 bg-[var(--bg-secondary)] p-6 rounded-[2rem] border border-[var(--border-color)] items-center shadow-sm">
