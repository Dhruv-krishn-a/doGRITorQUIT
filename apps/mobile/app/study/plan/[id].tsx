...
const PlanDetail: React.FC<PlanDetailProps> = ({ track, units }) => {
  ...
  return (
    <View className="flex-1 bg-[var(--bg-primary)]">
      {/* Header */}
      <View className="pt-16 px-6 pb-8 bg-[var(--bg-card)] border-b border-[var(--border-color)] shadow-sm">
              ...
              <View className="space-y-3">
                {mUnits.map(u => (
                  <TouchableOpacity 
                    ...
                    className="p-5 bg-[var(--bg-card)] rounded-[2rem] border border-[var(--border-color)] flex-row items-center justify-between shadow-sm"
                  >
