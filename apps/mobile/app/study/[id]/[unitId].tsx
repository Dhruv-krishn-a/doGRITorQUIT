...
const UnitSession: React.FC<UnitSessionProps> = ({ track, unit }) => {
 ...
 <View className="px-6 py-4 border-b border-[var(--border-color)] bg-[var(--bg-card)] flex-row items-center justify-between ">
 <View className="flex-1">
 ...
 className={`w-10 h-10 rounded-xl items-center justify-center ${isPaused ? 'bg-[var(--accent-color)]' : 'bg-[var(--bg-secondary)] border border-[var(--border-color)]'}`}
 >
 ...
 className="h-10 px-5 bg-[var(--text-primary)] rounded-xl items-center justify-center "
 >
 ...
 />
 <TouchableOpacity onPress={handleAddQuestion} className="w-10 h-10 bg-[var(--accent-color)] rounded-xl items-center justify-center active:scale-90 transition-all">
