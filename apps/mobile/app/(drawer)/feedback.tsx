...
export default function MobileDeveloperHub() {
 ...
 {/* Header */}
 <View className="px-6 pt-16 pb-4 bg-[var(--bg-card)] border-b border-[var(--border-color)] ">
 <View className="mb-8">
 ...
 className={`w-full py-6 rounded-3xl items-center ${!message.trim() ? 'bg-gray-500 opacity-20' : 'bg-[var(--accent-color)] '}`}
 >
