...
export default function NotesPage() {
 ...
 // Note: To be safe we should ideally have user.id from context here, 
 // but assuming the table sync handles segregation, we'll focus on the category bug.
 ...
 activeCategory === cat ? 'bg-[var(--accent-color)] border-[var(--accent-color)]' : 'bg-[var(--bg-secondary)] border-[var(--border-color)]'
 }`}>
