...
export default function ProfilePage() {
 ...
 <View className="transform-gpu w-32 h-32 bg-[var(--bg-secondary)] rounded-[2.5rem] items-center justify-center mb-6 ">
 ...
 className="bg-rose-500 p-6 rounded-[2rem] items-center flex-row justify-center mt-10"
 >
