...
export default function SubscriptionsPage() {
 ...
 isActive ? 'bg-[var(--bg-primary)]/10 border border-[var(--bg-primary)]/20' : 'bg-[var(--text-primary)] '
 }`}
 >
 {isBuying ? (
 ...
 {/* Compact HUD */}
 <View className="mx-6 p-6 bg-[var(--bg-card)] rounded-[2.5rem] border border-[var(--border-color)] mb-8 ">
 ...
 className={`flex-1 py-3 rounded-xl items-center ${activeTab === 'PLANS' ? 'bg-[var(--bg-card)] border border-[var(--border-color)] ' : ''}`}
 >
 ...
 className={`flex-1 py-3 rounded-xl items-center ${activeTab === 'HISTORY' ? 'bg-[var(--bg-card)] border border-[var(--border-color)] ' : ''}`}
 >
 ...
 <View key={item.id} className="flex-row items-center justify-between p-6 bg-[var(--bg-card)] rounded-3xl border border-[var(--border-color)] mb-4 ">
 <View>
