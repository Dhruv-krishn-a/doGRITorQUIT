    ...
    <View className="flex-1 bg-[var(--bg-primary)]">
                ...
                <View className="flex-row flex-wrap gap-2">
                  {goals.map(goal => (
                    <TouchableOpacity 
                      ...
                      className={`px-5 py-3 rounded-2xl border ${selectedGoalIds.includes(goal.id) ? 'bg-[var(--accent-color)] border-[var(--accent-color)] shadow-lg shadow-sky-500/20' : 'bg-[var(--bg-secondary)] border border-[var(--border-color)]'}`}
                    >
      ...
      <ScrollView className="flex-1 bg-[var(--bg-primary)]" contentContainerStyle={{ paddingBottom: 120, paddingTop: 60 }}>
        ...
        <View className="px-6 mb-8 text-left flex-row justify-between items-end">
          ...
          <TouchableOpacity onPress={() => setShowAddBlock(true)} className="px-6 py-4 bg-[var(--accent-color)] rounded-2xl shadow-lg shadow-sky-500/20">
        ...
        <View className="px-6 mb-10">
           <View className="bg-[var(--bg-card)] border border-[var(--border-color)] rounded-[2.5rem] p-6 shadow-sm">
        ...
        <View className="px-6 mb-10 text-left">
          <View className="p-8 bg-[var(--bg-card)]/50 border border-[var(--border-color)] rounded-[3rem] shadow-sm relative overflow-hidden">
          ...
          <View className="space-y-6">
            {scheduleData.allocated.map((task) => (
              <View key={task.id} className="flex-row gap-6 mb-6">
                ...
                <View className="flex-1 p-6 bg-[var(--bg-card)] border border-[var(--border-color)] rounded-[2.5rem] shadow-sm relative overflow-hidden group">
                  ...
                  <View className="flex-row items-center justify-between">
                    ...
                    <View className="flex-row gap-3">
                      ...
                      <TouchableOpacity onPress={() => handleComplete(task)} className="w-12 h-12 bg-emerald-500/10 rounded-2xl items-center justify-center border border-emerald-500/20 active:scale-95 transition-all shadow-sm">
