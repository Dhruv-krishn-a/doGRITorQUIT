...
export default function Footer({ nav }: { nav: NavItem[] }) {
  ...
  return (
    <footer className="relative bg-[#fdfbfb] pt-12 pb-6 border-t border-slate-100 overflow-hidden font-sans text-slate-600 antialiased">
        ...
        <div className="pt-6 border-t border-slate-200/80 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-6">
            ...
            <div className="flex gap-4 text-[10px] font-bold uppercase tracking-widest">
              <Link href="/privacy" className="text-slate-400 hover:text-slate-800 transition-colors">Privacy</Link>
              <Link href="/terms" className="text-slate-400 hover:text-slate-800 transition-colors">Terms</Link>
            </div>
          </div>
