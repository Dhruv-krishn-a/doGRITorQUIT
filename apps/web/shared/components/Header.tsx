  ...
  return (
    <>
      <motion.header 
        ...
        className="fixed top-0 inset-x-0 z-50 w-full border-b border-slate-200/60 bg-white/80 backdrop-blur-md supports-backdrop-filter:bg-white/60 transition-all duration-300"
      >
