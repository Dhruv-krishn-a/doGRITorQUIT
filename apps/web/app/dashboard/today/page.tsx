...
export default async function TodayPage() {
  ...
  return (
    <div className="transform-gpu w-full max-w-[1600px] mx-auto px-6 md:px-10 py-10 bg-[var(--bg-primary)]">
      <Suspense fallback={
        <div className="transform-gpu flex flex-col items-center justify-center min-h-[60vh] gap-4">
          ...
          <div className="transform-gpu text-[var(--accent-color)] font-black uppercase tracking-widest text-xs italic">Synchronizing Horizon...</div>
        </div>
      }>
        <TodayUI />
      </Suspense>
