...
export default function Footer({ nav }: { nav: NavItem[] }) {
  ...
  return (
    <footer className="relative bg-[var(--bg-primary)] pt-12 pb-6 border-t border-[var(--border-color)] overflow-hidden font-sans text-[var(--text-secondary)] antialiased mt-auto">
        ...
        <div className="pt-6 border-t border-[var(--border-color)] flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-6">
            ...
            <div className="flex gap-4 text-[10px] font-bold uppercase tracking-widest">
              <Link to="/privacy" className="text-[var(--text-secondary)] hover:text-[var(--text-primary)] transition-colors">Privacy</Link>
              <Link to="/terms" className="text-[var(--text-secondary)] hover:text-[var(--text-primary)] transition-colors">Terms</Link>
            </div>
          </div>
