          ...
          >
            ...
            <div className="transform-gpu relative z-10">
                <div className="transform-gpu flex justify-between items-center mb-6">
                    <h4 className="transform-gpu font-black text-[var(--text-primary)] flex items-center gap-2 uppercase italic tracking-tighter leading-none text-left">
                ...
                <div className="transform-gpu space-y-6 text-left">
                {/* Topic Input */}
                <div>
