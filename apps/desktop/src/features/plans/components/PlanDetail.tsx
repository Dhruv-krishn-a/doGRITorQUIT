...
export default function PlanDetail({ planId }: { planId: string }) {
 ...
 if (error || !plan) return <div className="p-8 text-red-500">Error loading plan: {error}</div>;
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
           <div className="flex items-center gap-3 mb-2">
            <Button variant="ghost" onClick={() => navigate(-1)} className="text-slate-400 hover:text-slate-600 p-0 h-auto">←</Button>
     ...
     <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
       ...
       <div className="lg:col-span-4 space-y-4">
        <div className="flex items-center justify-between mb-2">
          ...
          <button className="text-xs font-medium text-purple-600 hover:text-purple-700">Collapse All</button>
        </div>
       ...
       <div className="lg:col-span-8">
         ...
         <div className="flex items-center gap-2 mb-4">
          ...
          <span className="text-xs font-medium text-slate-400 ml-auto">{currentDayTasks.filter(t => t.status ==="Completed" || t.status ==="completed" || t.status ==="Completed" ).length}/{currentDayTasks.length} Completed</span>
         </div>
