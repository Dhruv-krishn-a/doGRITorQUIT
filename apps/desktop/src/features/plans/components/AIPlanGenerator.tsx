  ...
  const content = (
    <>
      <AnimatePresence mode="wait">
        {open && (
          <div className="fixed inset-0 z-[12000] flex items-center justify-center p-2 sm:p-4 text-left italic">
            ...
            <motion.div
              ...
              className="transform-gpu relative bg-[var(--bg-primary)] w-full max-w-7xl h-[95vh] sm:h-[90vh] rounded-[3rem] flex flex-col lg:flex-row overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,0.15)] border border-[var(--border-color)] z-10"
            >
      ...
      >
        <div className="flex flex-col items-center text-center gap-6 py-6 italic">
