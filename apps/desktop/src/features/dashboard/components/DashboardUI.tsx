  ...
  return (
    ...
    >
      ...
      <div className="transform-gpu flex flex-col md:flex-row gap-6 items-stretch">
        ...
        {/* Welcome & Level */}
        <div className="transform-gpu flex-1 bg-white rounded-[2rem] p-6 border border-slate-100 shadow-sm flex items-center justify-between relative overflow-hidden">
           <div className="transform-gpu relative z-10">
              ...
              <div className="transform-gpu flex items-center gap-3">
                 ...
                 <div className="transform-gpu h-2.5 w-48 bg-slate-100 rounded-full overflow-hidden">
                    <div className="transform-gpu h-full bg-gradient-to-r from-indigo-500 to-purple-500" style={{ width: `${xpPercentage}%` }} />
                 </div>
           ...
           {/* Decorative BG */}
           <div className="transform-gpu absolute right-0 top-0 h-full w-1/3 bg-gradient-to-l from-indigo-50/50 to-transparent pointer-events-none" />
        ...
        <div className="transform-gpu flex gap-4">
           <button className="transform-gpu flex flex-col items-center justify-center w-24 h-full bg-indigo-600 hover:bg-indigo-700 text-white rounded-[2rem] transition-all shadow-lg shadow-indigo-200">
              <Play size={24} className="transform-gpu mb-1 fill-white" />
              <span className="transform-gpu text-xs font-bold">Focus</span>
           </button>
           <button className="transform-gpu flex flex-col items-center justify-center w-24 h-full bg-white hover:bg-slate-50 border border-slate-200 text-slate-600 rounded-[2rem] transition-all">
      ...
      <div className="transform-gpu grid grid-cols-1 md:grid-cols-4 gap-6 h-auto md:h-[500px]">
        
        {/* COL 1: Main Stats (Vertical) */}
        <div className="transform-gpu md:col-span-1 flex flex-col gap-6 h-full">
           {/* Focus Card */}
           <div className="transform-gpu flex-1 bg-gradient-to-br from-slate-900 to-slate-800 rounded-[2.5rem] p-6 text-white flex flex-col justify-between relative overflow-hidden group">
                 ...
                 <div className="transform-gpu z-10">
                    ...
                    <div className="transform-gpu w-full h-4 bg-slate-100 rounded-full overflow-hidden p-1">
                       <motion.div 
                          ...
                          className="transform-gpu h-full bg-gradient-to-r from-indigo-500 to-purple-500 rounded-full" 
                       />
                    </div>
                 </div>
              ) : (
                 <Link to="/plans" className="transform-gpu z-10 text-indigo-600 font-bold hover:underline">Start a Plan &rarr;</Link>
              )}
              
              {/* Background Graph Decoration */}
              <div className="transform-gpu absolute bottom-0 left-0 right-0 h-24 bg-gradient-to-t from-indigo-50/50 to-transparent pointer-events-none" />
           </div>
           ...
           <div className="transform-gpu h-1/2 grid grid-cols-2 gap-6">
              ...
              <div className="transform-gpu bg-white rounded-[2.5rem] border border-slate-100 p-6 overflow-y-auto">
                 <div className="transform-gpu flex justify-between items-center mb-4">
                    ...
                    <Link to="/daily-checklist" className="transform-gpu text-slate-400 hover:text-indigo-600"><MoreHorizontal size={18}/></Link>
                 </div>
        ...
        <div className="transform-gpu md:col-span-1 bg-white rounded-[2.5rem] border border-slate-200 p-6 h-full flex flex-col overflow-hidden shadow-xl shadow-slate-200/50">
           ...
           <Link to="/tasks" className="transform-gpu mt-4 flex items-center justify-center gap-2 w-full py-3 rounded-xl bg-slate-50 text-slate-600 text-sm font-bold hover:bg-slate-100 transition-colors">
