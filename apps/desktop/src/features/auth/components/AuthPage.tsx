...
export default function AuthPage({ view }: AuthPageProps) {
  ...
  return (
    <div className="min-h-screen w-full flex bg-[#FDF2F8] relative overflow-hidden font-sans text-slate-900">
      ...
      <div className="absolute top-[-20%] left-[-10%] w-[800px] h-[800px] bg-purple-200/40 rounded-full blur-[120px] pointer-events-none animate-pulse-slow" />
      <div className="absolute bottom-[-20%] right-[-10%] w-[600px] h-[600px] bg-pink-200/40 rounded-full blur-[100px] pointer-events-none" />

      <div className="w-full max-w-6xl mx-auto flex items-center justify-center p-4 relative z-10">
        
        <div className="grid lg:grid-cols-2 w-full bg-white/60 backdrop-blur-xl rounded-[40px] shadow-2xl shadow-purple-900/10 border border-white/50 overflow-hidden min-h-[600px]">
          
          {/* --- LEFT SIDE: Visuals --- */}
          <div className="hidden lg:flex flex-col justify-between p-12 bg-gradient-to-br from-indigo-600 to-purple-700 relative text-white overflow-hidden">
          ...
          >
            ...
            <motion.div variants={itemVariants} className="mb-8">
              ...
              <p className="text-slate-500 mt-2">
                ...
                <Link to={view === 'login' ? "/signup" : "/login"} className="text-indigo-600 font-bold hover:underline ml-1">
            ...
            <form onSubmit={handleAuth} className="space-y-4">
              ...
              {view === 'login' && (
                <motion.div variants={itemVariants} className="flex justify-end">
                  <Link to="/forgot-password" className="text-xs font-bold text-slate-500 hover:text-indigo-600 transition-colors">
                    Forgot password?
                  </Link>
                </motion.div>
              )}
